	...
	return (
		<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
			...
			<div className="grid md:grid-cols-3 gap-8">
				<div className="bg-white/80 dark:bg-background backdrop-blur-sm p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 text-center group hover-scale animate-fade-in">
				...
				<div
					className="bg-white/80 dark:bg-background backdrop-blur-sm p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 text-center group hover-scale animate-fade-in"
