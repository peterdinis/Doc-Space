...
import { Star, ArrowRight, Zap, Shield, Globe, Users, Share2, Edit } from "lucide-react";
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="space-y-8 animate-fade-in">
                        <div className="inline-flex items-center bg-gradient-to-r from-blue-100 to-purple-100 rounded-full px-4 py-2 animate-scale-in">
                            ...
                            <span className="text-sm font-medium text-blue-800">✨ New: Real-time collaboration features</span>
                        </div>
                        ...
                        <p className="text-xl text-gray-600 leading-relaxed">
                            DocSpace is a modern document collaboration platform that lets you create, edit, and share documents in real-time with your team. Simple, powerful, and secure.
                        </p>

                        <div className="flex flex-col sm:flex-row gap-4 animate-scale-in">
                            <Button size="lg" asChild className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white hover-scale group">
                                <Link href="/register" className="flex items-center justify-center">
                                    Start Creating
                                    <ArrowRight className="ml-2 h-4 w-4 group-hover:translate-x-1 transition-transform" />
                                </Link>
                            </Button>
                            <Button size="lg" variant="outline" asChild className="hover-scale border-2">
                    ...
                    <div className="relative animate-scale-in" style={{ animationDelay: '0.2s' }}>
                        ...
                        <div className="absolute inset-0 -z-10">
                            ...
                            <div className="absolute bottom-1/4 right-1/4 w-24 h-24 bg-purple-200 rounded-full opacity-20 animate-pulse" style={{ animationDelay: '1s' }}></div>
                        </div>
                    </div>
                </div>
                ...
                <div className="mt-20 text-center animate-fade-in" style={{ animationDelay: '0.4s' }}>
                    ...
                    <div className="flex justify-center items-center space-x-8 opacity-60">
                        ...
                        <div className="h-8 w-20 bg-gray-300 rounded animate-pulse" style={{ animationDelay: '0.2s' }}></div>
                        <div className="h-8 w-20 bg-gray-300 rounded animate-pulse" style={{ animationDelay: '0.4s' }}></div>
                        <div className="h-8 w-20 bg-gray-300 rounded animate-pulse" style={{ animationDelay: '0.6s' }}></div>
                    </div>
                </div>
            </div>
                ...
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
                    <div className="animate-fade-in">
                        ...
                        <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
                            Experience seamless real-time collaboration with advanced features designed for modern teams.
                        </p>
                        ...
                        <div className="grid md:grid-cols-3 gap-8 mt-12">
                            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 hover:bg-white/15 transition-colors duration-300 animate-scale-in">
                                ...
                                <p className="text-blue-100 text-sm">See changes in real-time</p>
                            </div>

                            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 hover:bg-white/15 transition-colors duration-300 animate-scale-in" style={{ animationDelay: '0.1s' }}>
                                ...
                                <p className="text-blue-100 text-sm">Perfect collaboration flow</p>
                            </div>

                            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 hover:bg-white/15 transition-colors duration-300 animate-scale-in" style={{ animationDelay: '0.2s' }}>
                                ...
                                <p className="text-blue-100 text-sm">Control access precisely</p>
                            </div>
                        </div>
                    </div>
                </div>
